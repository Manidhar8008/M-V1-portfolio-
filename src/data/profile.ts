...
export const MANIDHAR_PROFILE = {
  ...
  tagline: 'Building personal intelligence infrastructure, AI agents, and knowledge systems.',
  bio: 'Founder building AI systems that transform information into decisions, workflows, and leverage. Focused on local-first intelligence, retrieval systems, automation, and human-AI collaboration.',
...
export const VASUKI_METRICS: MetricItem[] = [
  {
    ...
    value: '8+',
    description: 'Personal AI, automation, and knowledge systems.',
    icon: 'Cpu',
  },
  {
    label: 'Architectures Designed',
    value: '5+',
    description: 'End-to-end AI and data system architectures.',
    icon: 'Network',
  },
  {
    label: 'AI Agents Built',
    value: '4+',
    description: 'Multi-agent and workflow automation systems.',
    icon: 'Brain',
  },
  {
    label: 'Knowledge Records Processed',
    value: '172K+',
    description: 'Structured records processed by Vasuki.',
    icon: 'FolderOpen',
  },
];
...
{
  id:"vasuki",
  question:"Explain Vasuki architecture",
  label:"Architecture",
  icon:"Network"
},
...
{
  id:"impact",
  question:"What business problems were solved?",
  label:"Impact",
  icon:"Zap"
},
...
{
  id:"experience",
  question:"Show AI engineering experience",
  label:"Experience",
  icon:"Code"
},
...
export const GENERIC_FALLBACK_ANSWER = `Ask about projects, architecture decisions, AI systems, automation workflows, engineering experience, or the Vasuki platform.`;
